...
// Reset resets the decoder with a new maximum dynamic table size and emit callback,
// allowing decoder reuse without heap allocations.
func (d *Decoder) Reset(maxDynamicTableSize uint32, emitFunc func(f HeaderField)) {
	d.emit = emitFunc
	d.emitEnabled = true
	d.firstField = true
	d.buf = nil
	...
	d.dynTab.table.byNameValue = nil
	d.dynTab.size = 0
	d.dynTab.allowedMaxSize = maxDynamicTableSize
	d.dynTab.setMaxSize(maxDynamicTableSize)
}
