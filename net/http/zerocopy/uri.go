...
var ErrorInvalidURI = errors.New("mach: invalid uri")
...
func (u *URI) Parse(host, uri []byte) error {
	return u.ParseInternal(host, uri, false)
}

func (u *URI) ParseInternal(host, uri []byte, isTLS bool) error {
	u.Reset()
