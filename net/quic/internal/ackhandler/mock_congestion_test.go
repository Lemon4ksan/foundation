...
//
//	mockgen -typed -build_flags=-tags=gomock -package ackhandler -destination congestion.go github.com/lemon4ksan/sein/internal/quic/internal/congestion SendAlgorithmWithDebugInfos
//
