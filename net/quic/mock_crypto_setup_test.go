...
//
//	mockgen -typed -build_flags=-tags=gomock -package quic -destination crypto_setup.go github.com/lemon4ksan/sein/internal/quic/internal/handshake CryptoSetup
//
