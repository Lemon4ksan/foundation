...
//
//	mockgen -typed -build_flags=-tags=gomock -package quic -destination long_header_opener.go github.com/lemon4ksan/sein/internal/quic/internal/handshake LongHeaderOpener
//
