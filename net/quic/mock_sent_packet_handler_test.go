...
//
//	mockgen -typed -build_flags=-tags=gomock -package quic -destination ackhandler/sent_packet_handler.go github.com/lemon4ksan/sein/internal/quic/internal/ackhandler SentPacketHandler
//
