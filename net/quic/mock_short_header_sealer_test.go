...
//
//	mockgen -typed -build_flags=-tags=gomock -package quic -destination short_header_sealer.go github.com/lemon4ksan/sein/internal/quic/internal/handshake ShortHeaderSealer
//
