...
// allocKernelPage allocates a raw unpaged physical memory slab directly from Linux OS kernel via mmap.
...
// freeKernelPage releases raw physical memory page back to Linux OS kernel via munmap.
