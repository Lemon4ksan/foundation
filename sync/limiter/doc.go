...
//     [AdaptiveLimiter.Acquire]'s cancellation block checks if the waiter channel was
//     already popped and closed by [AdaptiveLimiter.Release]. If it was, the method
//     discards the context cancellation and returns success (nil) to ensure the acquired
//     slot is eventually released.
//  2. Safe Math Invariant: All RTT inputs are sanitised to be at least 1 nanosecond.
//     This completely prevents division-by-zero, NaN, and positive infinity propagation
//     in the Vegas congestion control math.
//
// # Error Handling
//
